...
global.ppulsa = '01280860293' //Nomor SimCard Yang Kamu Pake
global.psaweria = '-' //Link Saweriamu Kalo Nggada Ketik - aja

/*============== NOMOR ==============*/
global.nomorbot = '6285694795451' //Nomor Bot
global.nomorown = '6285736178354' //Nomor Owner
global.namebot = '𝙓𝙮𝙧𝙮𝙪 𝘽𝙤𝙩' //Nama Bot
global.nameown = '𝙓𝙮𝙧𝙮𝙪' // Nama Owner


/*============== STAFF ==============*/
global.owner = [
  ['6285736178354', '❦ 𝙓𝙮𝙧𝙮𝙪 🎐', true] //Ganti jd nomormu sama Namamu
...
/*============== WATERMARK ==============*/
global.wm = '                「 𝙓𝙮𝙧𝙮𝙪 𝘽𝙤𝙩 汉  」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘𝙓𝙮𝙧𝙮𝙪 𝘽𝙤𝙩˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ 𝙓𝙮𝙧𝙮𝙪 𝘽𝙤𝙩'
